  ...
  <div className="profile-info col-md-9">
      <div className="panel">
          <div className="bio-graph-heading">
            C'era una volta una valle incantata dove un leggiadro anziano desiderava spendere i suoi ultimi anni di vita coltivando allegramente pezzi di barbabietola da zucchero.
          </div>
          <div className="panel-body bio-graph-info">
              ...
              <div className="row">
                  <div className="bio-row">
                      <p><span>Name </span>: Camila</p>
                  </div>
                  <div className="bio-row">
                      <p><span>Last Name </span>: Smith</p>
                  </div>
                  <div className="bio-row">
                      <p><span>Farm Location </span>: Australia</p>
                  </div>
                  <div className="bio-row">
...
{/*              <div className="col-md-6">
          ...
          <div className="card3">
              <div className="row">
                  <div className="col-2">
                      <img src="https://i.imgur.com/xELPaag.jpg" width="70" className="rounded-circle mt-2" alt="logo"/>
                  </div>
