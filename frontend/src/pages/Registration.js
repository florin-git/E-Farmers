                    ...
                    <div className="card text-black">
                        <div className="card-body p-md-5">
                            ...
                            <div className="d-flex flex-row align-items-center mb-4">
                                ...
                                <input type="text" className="form-control" id="name" ref={userRef} placeholder="Name"
                                value={formData.name} name="name" onChange={(event) => { handleChange(event); }} required />
                                </div>
                            </div>
                            ...
                            <div className="d-flex flex-row align-items-center mb-4">
                                ...
                                <input type="email" className={`form-control ${ !validEmail && "is-invalid" }`} id="email" placeholder="Email"
                                value={formData.email} name="email" onChange={(event) => { handleChange(event); }} required />
                            ...
                            <div className="d-flex flex-row align-items-center mb-4">
                                ...
                                <input type="password" className={`form-control ${ !validPsw && "is-invalid" }`} id="password" placeholder="Password" 
                                value={formData.password} name="password" onChange={(event) => { handleChange(event); }} required />
                                <p className="invalid-feedback">
                                    8 to 24 characters. <br /> Must include uppercase and lowercase letters, a number and a special character.
                            ...
                            <div className="d-flex flex-row align-items-center mb-4">
                                ...
                                <input type="password" className={`form-control ${ !validMatch && "is-invalid" }`} id="confirmPsw" placeholder="Password"
                                value={formData.confirmPsw} name="confirmPsw" onChange={(event) => { handleChange(event); }} required />
                                <span className="invalid-feedback">
                            ...
                            <div className="d-flex flex-row align-items-center mb-4">
                                ...
                                <FormControl fullWidth>
                                    ...
                                    <Select labelId="demo-simple-select-label" id="demo-simple-select" value={0} label="TypeOfAccount" >
                            ...
                            <div className="form-check d-flex justify-content-center mb-5">
                                ...
                                value={flagTOService} label="TermsOfService" onChange={(event) => { setflagTOService(event.target.value); }} />
