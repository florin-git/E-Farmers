...
function Delivery (){
  ...
  function handleUpdate(riderId){
    (async () => {
      await axiosOrder.updateOrder({payment_method_id, riderId})
      .then((res) => {
        setFlagPayment(1)
        if(riderId !== 0){
          const id = riderId;
        ...
        <div>
          ...
          <div className="container2">
            <div className="card">
              <div className="face face1">
                <div className="content">
                  <img src={rider} /><h3>Shipping with Rider</h3>
                </div>
              </div>
              <div className="face face2">
                <div className="content">
                  <p>If you select, shipping with rider, your shipping will be handled by the first available rider.</p>
            ...
            <div className="card">
              <div className="face face1">
                <div className="content">
                  <img src={warehouse}/><h3>Go to Warehouse</h3>
                </div>
              </div>
              <div className="face face2">
                <div className="content">
                    <p>In this way you need to pick up the goods at the warehouse</p>
